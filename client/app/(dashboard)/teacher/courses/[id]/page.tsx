    ...
    <section>
      ...
      <Form {...methods}>
        <form onSubmit={methods.handleSubmit(onSubmit)}>
          ...
          <section className="flex justify-between md:flex-row flex-col gap-10 mt-5 font-dm-sans">
            ...
            <section className="bg-customgreys-darkGrey mt-4 md:mt-0 p-4 rounded-lg basis-1/2">
